  ...
  return (
    <div className='text-center text-lg-start position-relative'>
      ...
      <div className='d-flex align-items-center py-2 option'>
        <i class="fa-solid fa-check textSite me-3"></i>
      ...
      {
        planOptionsTitles.map((optionTitle,index) => <div className={`d-flex option  align-items-center pt-2 ${index === 3 ? 'pb-4':'pb-2'}`}>
        <i class={`fa-solid fa-check  me-3 ${planOptions[index]? 'textSite':'textTransparent'}`}></i>
